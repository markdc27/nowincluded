		...
		<div class="container max-w-screen-xl flex justify-between relative items-center py-8 md:py-0">
			<div class="inline-block">
				<a href="/" class="site-logo block">
					<img src="/wp-content/themes/nowincluded/assets/images/site-logo.svg">
				</a>
			</div>
			...
			<div class="flex justify-center items-center md:hidden">
				<button type="button" name="mobile-menu-open" id="MobileMenuOpen" class="bg-white">
					<svg width="25" height="18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill="#1D1D1D" d="M0 0h25v3H0zM0 15h25v3H0zM0 7h25v3H0z"/></svg>
				</button>
			</div>
		</div>
	</header>
	<div class="mobile-menu-wrap relative hidden">
		<?php
			$args = array(
				'theme_location'	=> 'primary',
				'container'			=> 'nav',
