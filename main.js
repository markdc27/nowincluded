...
var splide;
splide = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_3__["default"]('.splide', (_Splide = {
  type: "fade",
  autoplay: true,
  interval: 5000,
  pauseOnHover: false,
  arrows: false,
  perPage: 1
}, _defineProperty(_Splide, "type", 'loop'), _defineProperty(_Splide, "pagination", true), _defineProperty(_Splide, "keyboard", false), _defineProperty(_Splide, "slideFocus", false), _defineProperty(_Splide, "height", '100%'), _Splide)).mount();
