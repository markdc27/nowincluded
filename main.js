...
var swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_2__["default"]('#StatSlider', {
  loop: true,
  navigation: {
...
var postSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_2__["default"](".post-slider", {
  loop: true,
  slidesPerView: 1,
  spaceBetween: 24,
  pagination: {
...
var callback = function callback() {
  ...
  var toggleMMB = document.getElementById('MobileMenuOpen');
  var mobileMenuOverlay = document.querySelector('.mobile-menu');
  var mobileMenuWrap = document.querySelector('.mobile-menu-wrap');

  if (toggleMMB) {
    toggleMMB.addEventListener('click', function (event) {
  ...
  var mobileMenuSubMenuParents = document.querySelectorAll('.mobile-menu li.menu-item-has-children > a');

  if (mobileMenuSubMenuParents) {
    for (var i = 0; i < mobileMenuSubMenuParents.length; i++) {
      mobileMenuSubMenuParents[i].addEventListener('click', function (event) {
  ...
  var toggleTagList = document.getElementById('TagListToggle');
  var tagList = document.getElementById('ExtraTagList');

  if (toggleTagList) {
    toggleTagList.addEventListener('click', function (event) {
      event.preventDefault();
      tagList.classList.toggle('hidden');
    });
  }

  var mobileToggleTagList = document.getElementById('MobileTaglistToggle');
  var mobileTagListContainer = document.querySelector('.js-tag-list-container');

  if (mobileToggleTagList) {
    mobileToggleTagList.addEventListener('click', function (event) {
      event.preventDefault();
...
/******/ 	__webpack_require__.O(undefined, ["editor-styles","style"], () => (__webpack_require__("./assets/js/main.js")))
/******/ 	__webpack_require__.O(undefined, ["editor-styles","style"], () => (__webpack_require__("./assets/css/style.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["editor-styles","style"], () => (__webpack_require__("./assets/css/editor-styles.scss")))
